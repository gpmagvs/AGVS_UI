<template>
  <div class="w-100">
        ...
        <el-table-column label="目前累計里程" prop="currentHorizonMotorVal">
          <template #default="scope">
            <div class="w-100 d-flex value-display">
              ...
              >{{ scope.row.currentHorizonMotorVal.toFixed(3) }} km</div>
        ...
        <el-table-column label="保養里程" prop="horizonMotorMaintainVal">
          <template #default="scope">
            <div class="w-100 d-flex value-display">
              ...
              <el-button
                @click="ShowSettingDialog(scope.row.agv_name, 100, scope.row.horizonMotorMaintainVal)"
              >設定</el-button>
            </div>
          </template>
        </el-table-column>
        ...
        <el-table-column label="保養里程" prop="forkBeltMaintainVal">
          <template #default="scope">
            <div class="w-100 d-flex value-display">
              ...
              <el-button
                @click="ShowSettingDialog(scope.row.agv_name, 101, scope.row.forkBeltMaintainVal)"
              >設定</el-button>
            </div>
          </template>
        </el-table-column>
    ...
    <el-dialog
      :title="dialog.title"
      v-model="settingValueDialogShow"
      draggable
      :modal="false"
      width="400"
    >
      <div class="d-flex w-100">
        ...
        <el-button size="large" @click="() => { settingValueDialogShow = false }">取消</el-button>
      </div>
    </el-dialog>
  </div>
</template>
