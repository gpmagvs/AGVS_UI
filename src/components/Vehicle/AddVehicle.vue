<template>
  <div class="add-vehicle w-100">
    <el-form label-width="100px" label-position="left">
      ...
      <el-form-item label="SECS ID">
        <el-input class="add-vehicle-input" v-model="payload.AGV_ID"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    UpdatePayload(_payload = new clsAGVStateDto()) {
