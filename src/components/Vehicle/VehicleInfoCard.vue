      ...
      <div id="vehicle-info-card-position">
        <div>
          ...
          <el-tooltip content="追隨AGV，AGV將保持顯示於地圖中央" placement="top">
            <i v-if="!IsOpUsing" style="cursor: pointer;height: 22px;position: relative;top: 2px;border-radius: 30px;width: 22px;padding-left: 4px;font-size: 18px;" class="bi bi-eyeglasses mx-1" @click="() => { $emit('OnTrackingVehicleClick', vehicleStateData.AGV_Name) }"
              v-bind:style="isMapViewTracking ? { backgroundColor: 'rgb(13, 110, 253)', color: 'white' } : {}"></i>
          </el-tooltip>
        </div>
