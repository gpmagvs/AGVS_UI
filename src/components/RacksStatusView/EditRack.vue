        ...
        <div class="rack-basic-properties border px-3 mx-2 rounded">
          <el-form label-width="100px" label-position="left" style="width:400px">
            ...
            <el-form-item label="Row(層數)">
              <el-input-number
                :min="1"
                class="add-rack-input"
                v-model="rackOptions.Rows"
                @input="HandleRowChanged"
              ></el-input-number>
            </el-form-item>
            <el-form-item label="Col">
              <div class="d-flex flex-column">
                <el-input-number
                  :min="1"
                  class="add-rack-input"
                  v-model="rackOptions.Columns"
                  @input="HandleColChanged"
                ></el-input-number>
                <el-popover
                  placement="bottom-end"
                  v-model="colRowSelectorShow"
                  width="400"
                  trigger="click"
                >
                  <template #reference>
                    <div style="width:26px">
                      <i class="bi bi-grid-3x3" style="font-size: 26px;"></i>
                    </div>
                  </template>
                  <ColumnRowSelector
                    :maxRowNum="3"
